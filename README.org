...
* Notice
The tools in this package have polished a bit and submitted in a [[https://github.com/skissue/llm-tool-collection/pull/4][PR]] to [[https://github.com/skissue/llm-tool-collection][llm-tool-collection]], where future development will presumably take place.  I'll leave this repo here for now, but might eventually delete it.
...
Install =codel= from this repository with your preferred package manager, or
place =codel.el= on your =load-path= and require it.
